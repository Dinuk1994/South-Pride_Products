        ...
        <dialog ref={addToCartRef} id="confirm_modal_1" className="modal">
          <div className="modal-box bg-base-200">
            ...
            <div className="flex justify-center items-center mt-4">
              <button
                className="btn bg-gray-200 text-gray-800 hover:bg-gray-300 px-4"
              ...
              <input
                type="text"
                readOnly
                className="mx-2 text-center border border-gray-300 rounded-md w-12"
                value={quantity}
              />
              <button
                className="btn bg-gray-200 text-gray-800 hover:bg-gray-300 px-4"
            ...
            <div className="modal-action mt-4">
              <form method="dialog">
                <button
                  className={`btn bg-blue-400 text-white hover:text-black ${loading ? 'loading' : ''}`}
                  onClick={() => {
