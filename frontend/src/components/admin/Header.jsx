    ...
    <div>
      <div className="navbar bg-AdminHeader ">
        <div className="flex-1">
          ...
          <a className="pl-3 text-xl mobile:ml-5 text-white mobile:text-sm font-bold">Administration - <span className="text-yellow-200 mobile:text-sm text-nowrap">South Pride Products</span></a>
        </div>
        <div className="flex ">
          ...
          <label className="text-[15px] mobile:text-[10px] mobile:ml-0 ml-2 text-yellow-200" htmlFor="">{userEmail}</label>
